...
"""
Pareto set
this script is adapted from https://github.com/SJ001/AI-Feynman
"""
...
class ParetoSet(SortedKeyList):
    ...
    def _input_check(self, p):
        ...
        if isinstance(p, ParetoPoint):
            ...
            return ParetoPoint(x=p[0], y=p[1], data=None)
        else:
            raise TypeError("Must be instance of ParetoPoint or 2-tuple.")
